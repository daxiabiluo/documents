...
> http://192.168.1.233/API/V1/history?startTime=2019-07-09&tagID=Device1.tag0001(192.168.1.233为需要进行写操作的网关的ip地址，startTime为需要获取历史数据的指定日期，tagID为需要获取历史数据的指定Tag点)
